...
Source0  : https://cpan.metacpan.org/authors/id/O/OM/OMEGA/PDF-Table-0.12.tar.gz
Source1  : http://http.debian.net/debian/pool/main/libp/libpdf-table-perl/libpdf-table-perl_0.10.1-1.debian.tar.xz
Summary  : 'A utility class for building table layouts in a PDF::API2  (or PDF::Builder) object.'
...
%prep
%setup -q -n PDF-Table-0.12
cd %{_builddir}
tar xf %{_sourcedir}/libpdf-table-perl_0.10.1-1.debian.tar.xz
cd %{_builddir}/PDF-Table-0.12
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/PDF-Table-0.12/deblicense/
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/PDF/Table.pm
