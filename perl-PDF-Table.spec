...
Source0  : https://cpan.metacpan.org/authors/id/O/OM/OMEGA/PDF-Table-1.004.tar.gz
...
%prep
%setup -q -n PDF-Table-1.004
cd %{_builddir}
tar xf %{_sourcedir}/libpdf-table-perl_0.10.1-1.debian.tar.xz
cd %{_builddir}/PDF-Table-1.004
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/PDF-Table-1.004/deblicense/
