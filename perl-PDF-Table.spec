...
Requires: perl-PDF-Table-man

%description


%package man
Summary: man components for the perl-PDF-Table package.
Group: Default

%description man
man components for the perl-PDF-Table package.
...
mkdir -p %{_topdir}/BUILD/PDF-Table-0.10.1/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/PDF/Table.pm
