...
Source0  : https://cpan.metacpan.org/authors/id/O/OM/OMEGA/PDF-Table-1.001.tar.gz
...
%prep
%setup -q -n PDF-Table-1.001
cd %{_builddir}
tar xf %{_sourcedir}/libpdf-table-perl_0.10.1-1.debian.tar.xz
cd %{_builddir}/PDF-Table-1.001
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/PDF-Table-1.001/deblicense/
